...
- How dark patterns exploit cognitive biases, leading to unintentional purchases, data sharing, or subscription traps.
- Highlighting real-world incidents where users suffered due to misleading design practices (e.g., lawsuits or regulatory fines against companies).
...
- Visual breakdown of the most frequently used dark patterns across different industries (e.g., e-commerce, social media, finance).
- Incorporating qualitative data from existing research or user feedback on their experiences with dark patterns.
...
<div align="center">
  <p><em>Left: Page sketches | Right: Page Layout</em></p>
</div>
...
- Dark Pattern Classifications Dataset [(Kaggle)](https://www.kaggle.com/datasets/rohitdnath/dark-pattern-dataset?resource=download&select=dark_pattern_classifications.csv)
  - This dataset categorizes dark patterns based on their type (e.g., Sneak into Basket, Forced Continuity, Roach Motel) and identifies specific websites where these patterns have been observed.
  - It provides a structured classification that will help in analyzing the most prevalent dark patterns.

- E-Commerce Dark Patterns Dataset [(GitHub)](https://github.com/yamanalab/ec-darkpattern)
  - This dataset focuses specifically on dark patterns in online shopping platforms, detailing manipulative tactics used to influence purchasing decisions.
  - It includes examples from various e-commerce websites, making it useful for identifying trends in deceptive design within retail.

- Dark Patterns in the Wild [(Zenodo)](https://zenodo.org/records/3601501)
  - This dataset consists of real-world examples of dark patterns across different industries, including finance, social media, and online services.
  - It offers a broader perspective on how dark patterns impact users across multiple domains.
